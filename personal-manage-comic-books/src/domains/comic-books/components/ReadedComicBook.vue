<template>
  <div class="comic-section">
    <h1 class="section-title">✅ Already Read</h1>
    <div v-if="comicBooks.length === 0" class="empty-state">
      <p>No comic books read yet. Start reading!</p>
    </div>
        ...
        <div class="comic-card-wrapper">
          <div class="comic-card" @click="toggleDetails(comicBook._id)">
            <div class="card-image-container">
              ...
              <span class="comic-badge read">Read</span>
            </div>
          ...
          <div class="card-actions">
            ...
            <button class="action-btn read-btn" title="Mark as unread">
